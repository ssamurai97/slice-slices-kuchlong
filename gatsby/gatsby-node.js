...
async function turnSliceMasterIntoPages({graphql, actions}){
  ...
  `);
    ...
    //3. figure out how many pages there are based on how many slicemasters theire are, and how many per page
    ...
    Array.from({length: pageCount}).forEach((_, i) => {
        ...
        actions.createPage({
            ...
            // this data pass to the template when create it
            context: {
                skip: i * pageSize,
                currentPage: i + 1,
                pageSize,
